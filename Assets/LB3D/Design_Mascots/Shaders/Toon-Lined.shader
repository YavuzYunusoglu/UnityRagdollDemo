    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 ToonFragment(Varyings input) : SV_Target
            {
                ...
                half outlineBand = smoothstep(_OutlineAmount - 0.01h, _OutlineAmount + 0.01h, rimDot);
                half3 outline = outlineBand * _OutlineColor.rgb;
                ...
                half3 color = lighting * _Color.rgb - outline;
                return half4(color * textureSample.rgb, _Color.a * textureSample.a);
            }
            ENDHLSL
        }
