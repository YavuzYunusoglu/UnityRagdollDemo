...
## Summary
- 124 nodes · 208 edges · 15 communities (9 shown, 5 thin omitted)
...
Cohesion: 0.16
Nodes (8): ConfigurableJoint, Rigidbody, Vector3, ActiveRagdollPoseDriver, JointTarget, RagdollDemo.Character, JointTarget, MonoBehaviour
...
### Community 8 - "PhysicsBoneFollower"
Cohesion: 0.39
Nodes (4): Quaternion, Rigidbody, Transform, PhysicsBoneFollower

### Community 9 - ".Awake"
Cohesion: 0.33
Nodes (4): JointDrive, ConfigurableJoint, Rigidbody, JointDriveSnapshot

### Community 13 - "BalanceState"
Cohesion: 0.40
...
- **Why does `PhysicsCharacterMotor` connect `PhysicsCharacterMotor` to `ActiveRagdollPoseDriver`, `PhysicsCharacterTelemetry`, `ShoulderCameraController`, `PhysicsCharacterBalanceController`, `.TryStepUp`, `Rigidbody`, `.Awake`, `.IsCharacterCollider`?**
  _High betweenness centrality (0.568) - this node is a cross-community bridge._
- **Why does `PhysicsCharacterBalanceController` connect `PhysicsCharacterBalanceController` to `PhysicsCharacterMotor`, `ActiveRagdollPoseDriver`, `.ApplyDriveScale`, `.Awake`, `.TickBalanced`, `.EnterFallen`, `BalanceState`?**
  _High betweenness centrality (0.488) - this node is a cross-community bridge._
- **Why does `ShoulderCameraController` connect `ShoulderCameraController` to `PhysicsCharacterMotor`, `ActiveRagdollPoseDriver`, `PhysicsCharacterTelemetry`?**
